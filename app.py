...
def download_model_if_needed():
    ...
    for filename, file_id in files.items():
        ...
        if not os.path.exists(path):
            print(f"\U0001F53D Downloading {filename} ...")
...
def predict():
    try:
        ...
        # Load model hanya saat ada request
        load_models()
